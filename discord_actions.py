...
async def get_recent_audit_logs(guild_id: str, limit: int = 5) -> str:
    ...
    try:
        ...
        return "Error: Bot lacks permission to view audit logs."
    except Exception as e:
        return f"Error: {str(e)}"
...
async def delete_role(guild_id: str, role_id: str) -> str:
    ...
    try:
        ...
        return "Error: Bot lacks permission or the role is higher than the bot's."
    except Exception as e:
        return f"Error: {str(e)}"
...
async def assign_role(guild_id: str, member_id: str, role_id: str) -> str:
    ...
    try:
        ...
        return "Error: Bot lacks permissions or the role is higher than the bot's."
    except Exception as e:
        return f"Error: {str(e)}"
