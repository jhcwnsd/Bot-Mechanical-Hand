...
class GeminiAgent:
    def __init__(self):
        ...
        self.system_instruction = (
            ...
            "- ASCII ART & BORDERS: Occasionally decorate your messages or frame information using simple, elegant text art "
            "or borders (e.g., using line borders `╔═══╗`, crosses `┼`, skulls `☠`, daggers `▬▬ι═══════ﺤ`, or simple ASCII frames) "
            "to make your responses look like a formal document or ledger. Keep them clean so they do not break on Discord mobile.\n"
